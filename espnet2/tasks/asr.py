...
from espnet2.asr.encoder.conformer_encoder_dual import ConformerEncoderDE
...
encoder_choices = ClassChoices(
    ...
    classes=dict(
        ...
        conformer_de=ConformerEncoderDE,
...
encoder_de_choices = ClassChoices(
    "encoder_de",
    classes=dict(
        conformer=ConformerEncoder,
        conformer_de=ConformerEncoderDE,
...
class ASRTask(AbsTask):
    ...
    class_choices_list = [
        ...
        encoder_choices,
        # --encoder_de and --encoder_de_conf
        encoder_de_choices,
    ...
    def build_model(cls, args: argparse.Namespace) -> ESPnetASRModel:
        ...
        if args.input_size is None:
            ...
            frontend_class_de = frontend_choices.get_class(args.frontend)
            frontend_de = frontend_class_de(**args.frontend_conf)
        ...
        if args.specaug is not None:
            ...
            specaug_class_de = specaug_choices.get_class(args.specaug)
            specaug_de = specaug_class_de(**args.specaug_conf)
        else:
            specaug = None
        ...
        if args.normalize is not None:
            ...
            normalize_class_de = normalize_choices.get_class(args.normalize)
            normalize_de = normalize_class_de(**args.normalize_conf)
        else:
            normalize = None
        ...
        encoder_class_de = encoder_de_choices.get_class(args.encoder)
        encoder_de = encoder_class_de(input_size=input_size, **args.encoder_conf)

        # 5. Post-encoder block
        # NOTE(kan-bayashi): Use getattr to keep the compatibility
        encoder_output_size = encoder.output_size()
        encoder_de_output_size = encoder_de.output_size()
        ...
        if getattr(args, "decoder", None) is not None:
            ...
            decoder_class_de = decoder_choices.get_class(args.decoder)
            ...
            if args.decoder == "transducer":
                ...
                decoder_de = decoder_class_de(
                    vocab_size=vocab_size,
                    encoder_output_size=encoder_de_output_size,
                    **args.decoder_conf,
                )
                joint_network = None
        else:
        ...
        ctc_de = CTC(
            odim=vocab_size, encoder_output_size=encoder_de_output_size, **args.ctc_conf
        )
        ...
        model = model_class(
            ...
            specaug=specaug,
            normalize=normalize,
            frontend_de=frontend_de,
            specaug_de=specaug_de,
            normalize_de=normalize_de,
