...
class Speech2Text:
    ...
    def __init__(
        ...
        decoder = asr_model.decoder_de

        ctc = CTCPrefixScorer(ctc=asr_model.ctc_de, eos=asr_model.eos)
    ...
    def _decode_single_sample(self, enc: torch.Tensor):
        if self.beam_search_transducer:
            ...
            if self.asr_model.decoder_de.causal_lm:
                forward_args, _ = self.asr_model.decoder_de.add_prefix_postfix(
                    enc,
