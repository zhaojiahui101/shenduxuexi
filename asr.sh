...
inference_asr_model=valid.acc.ave_5best.pth # ASR model path for decoding.
                                      # e.g.
...
test_sets="devman devsge"       # Names of test sets. Multiple items (e.g., both dev and eval sets) can be specified.
